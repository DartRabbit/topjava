...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:user_id AND m.dateTime>=:after and m.dateTime<=:before ORDER BY m.dateTime DESC")
})
